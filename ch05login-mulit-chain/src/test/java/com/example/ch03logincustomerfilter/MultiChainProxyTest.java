package com.example.ch03logincustomerfilter;
...
public class MultiChainProxyTest {
    ...
    TestRestTemplate testClient = new TestRestTemplate("choi", "1"); // 학생 choi:1 로 로그인
    ...
    void test_1(){
        ...
        assertNotNull(resp.getBody()); // 학생 리스트가 내려받았는지 확인
        assertEquals(3, resp.getBody().size()); // 학생 3명이 내려받았는지 확인
    }
